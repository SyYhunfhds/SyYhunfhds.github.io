...
```
![](assets/Pasted%20image%2020251025213006.png)
...
```
![](assets/Pasted%20image%2020251025222150.png)
每次都会有几个协程被落下
...
![](assets/Pasted%20image%2020251025230039.png)
![](assets/Pasted%20image%2020251025230120.png)
...
```
![](assets/Pasted%20image%2020251026001055.png)
加了`5000*2`次才到9999
## 锁
### 互斥锁 `sync.Mutex`
...
```
![](assets/Pasted%20image%2020251026001153.png)
虽然执行顺序还是乱的，但至少算对了
###  读写互斥锁 `sync.RWMutex`
