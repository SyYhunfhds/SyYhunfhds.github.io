...
![](语法/assets/Pasted%20image%2020251023220557.png)
```go
func main() {  
    now := time.Now()  
...
![](语法/assets/Pasted%20image%2020251023225335.png)
...
```
不设置时区就默认是格林威治时区
![](语法/assets/Pasted%20image%2020251023230709.png)![](语法/assets/Pasted%20image%2020251023230644.png)
### 时间间隔 `time.Duration`
...
直接赋值时可以不写键：
![](语法/assets/Pasted%20image%2020251024134112.png)
...
![](语法/assets/Pasted%20image%2020251024211401.png)
### 匿名字段
```go
type person struct {
	string
...
```
![](语法/assets/Pasted%20image%2020251024214036.png)
## 结构体（三）：序列化与反序列化
### 结构体与JSON互转
...
![](语法/assets/Pasted%20image%2020251024231136.png)
```go
type Person struct {  
    Name    string  
    Age     int  
